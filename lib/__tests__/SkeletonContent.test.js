...
describe('SkeletonComponent test suite', () => {
    ...
    it('should have the correct gradient properties', () => {
        ...
        const component = react_test_renderer_1.create(<TestComponent {...bonesProps}/>);
        ...
        component.update(<SkeletonContent_1.default {...bonesProps} animationDirection="diagonalTopLeft">
        ...
        component.update(<SkeletonContent_1.default {...bonesProps} animationDirection="diagonalTopRight">
        <react_native_1.Text style={{ fontSize: 24 }}/>
      </SkeletonContent_1.default>);
        gradient = component.root.findByType(react_native_linear_gradient_1.default);
        expect(gradient).toBeDefined();
        ...
        component.update(<SkeletonContent_1.default {...bonesProps} animationDirection="diagonalDownRight">
        <react_native_1.Text style={{ fontSize: 24 }}/>
      </SkeletonContent_1.default>);
        gradient = component.root.findByType(react_native_linear_gradient_1.default);
        expect(gradient).toBeDefined();
        ...
        component.update(<SkeletonContent_1.default {...bonesProps} animationDirection="verticalTop">
        <react_native_1.Text style={{ fontSize: 24 }}/>
      </SkeletonContent_1.default>);
        gradient = component.root.findByType(react_native_linear_gradient_1.default);
        expect(gradient).toBeDefined();
        expect(gradient.props.start).toEqual({ x: 0, y: 0 });
        expect(gradient.props.end).toEqual({ x: 0, y: 1 });
        component.update(<SkeletonContent_1.default {...bonesProps} animationDirection="verticalDown">
        <react_native_1.Text style={{ fontSize: 24 }}/>
      </SkeletonContent_1.default>);
        gradient = component.root.findByType(react_native_linear_gradient_1.default);
        expect(gradient).toBeDefined();
